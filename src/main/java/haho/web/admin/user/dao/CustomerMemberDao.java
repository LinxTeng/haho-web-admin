...
public class CustomerMemberDao {
     ...
     * @throws Exception
     */
    public TableResult<CustomerMemberDto> list(CustomerMemberDto customerMemberDto, PageInfo page) throws DataSourceSwithExcepion {
    ...
    // 计算分页总数
    PageInfo getPage(String sql, Object[] params, PageInfo page) throws DataSourceSwithExcepion {
        // 查询分页
     ...
     */
    @Transactional
    public ResultApi<Boolean> clearMobile(CustomerMemberDto customerMemberDto) throws DataSourceSwithExcepion {
